...
<h1>Status Pesanan Ini : <font color="Black"><?php echo $row1 ['status_transaksi'] ?></font></h1>
<br />
<p align="right">
<?php if (mysqli_num_rows($query)<1){?>
    <a class="btn btn-default disabled" href="cetaklpb.php?ID=<?php echo $ID?>">Cetak Laporan Penerimaan Barang</a>
    <a class="btn btn-default disabled" href="cetakspp.php?ID=<?php echo $ID?>">Cetak Surat Permintaan Pemesanan</a>
    <a class="btn btn-default disabled" href="cetakks.php?ID=<?php echo $ID?>">Cetak Kartu Stok Berdasarkan transaksi ini</a>
    <a class="btn btn-default disabled" href="ajukantransaksi.php?ID=<?php echo $ID?>">Ajukan Data Pemesanan</a> 
    <?php } elseif ($row1['status_transaksi']=="pending") {?>
    <a class="btn btn-default disabled" href="cetaklpb.php?ID=<?php echo $ID?>">Cetak Laporan Penerimaan Barang</a>
    <a class="btn btn-default disabled" href="cetakspp.php?ID=<?php echo $ID?>">Cetak Surat Permintaan Pemesanan</a>
    <a class="btn btn-default disabled" href="cetakks.php?ID=<?php echo $ID?>">Cetak Kartu Stok Berdasarkan transaksi ini</a>
    <a class="btn btn-default" href="ajukantransaksi.php?ID=<?php echo $ID?>">Ajukan Data Pemesanan</a>
    <?php } elseif ($row1['status_transaksi']=="Terkirim"||$row1['status_transaksi']=="Sukses") {?>
    ...
    <a class="btn btn-default disabled" href="ajukantransaksi.php?ID=<?php echo $ID?>">Ajukan Data Pemesanan</a></a><?php } else {?>
    <a class="btn btn-default disabled" href="cetaklpb.php?ID=<?php echo $ID?>">Cetak Laporan Penerimaan Barang</a>
    <a class="btn btn-default" href="cetakspp.php?ID=<?php echo $ID?>">Cetak Surat Permintaan Pemesanan</a>
    <a class="btn btn-default disabled" href="cetakks.php?ID=<?php echo $ID?>">Cetak Kartu Stok Berdasarkan transaksi ini</a>
    <a class="btn btn-default disabled" href="ajukantransaksi.php?ID=<?php echo $ID?>">Ajukan Data Pemesanan</a>
