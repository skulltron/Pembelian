    ...
    <div class="panel-body">
        ...
        <div class="panel-body">
            <table class="table table-responsive" border="1" style="width: 100%">
                ...
                $no=1;
                if ($q=='') {
                    $sql="SELECT * FROM tbtransaksi INNER JOIN tbsupplier ON tbtransaksi.id_supplier=tbsupplier.id_supplier ORDER BY tgl_transaksi DESC, id_transaksi DESC;";
                }
                else{
                    $sql="SELECT * FROM tbtransaksi INNER JOIN tbsupplier ON tbtransaksi.id_supplier=tbsupplier.id_supplier WHERE tbtransaksi.no_transaksi LIKE '%$q%' ORDER BY tgl_transaksi DESC, id_transaksi DESC;";
                }
