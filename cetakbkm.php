...
@media print {
 ...
 <center><table width="85%" class="tg"></center>
  ...
  <tr>
    ...
    $toadally1=$tgtotal*$pot/100;
    $toadally=$tgtotal-($tgtotal*$pot/100);

    $tglretur=$row['tgl_retur'];
    $ketretur=$row['keterangan_retur'];
    echo number_format(($toadally),0,'.','.');

    $sqlinsert="INSERT INTO tbjurnal (tgl_terima,keterangan,no_bukti,kas,potongan,penjualan,piutang_dg,rek,jumlah,id_supplier)
    VALUES ('$tglretur','Retur barang ($ketretur)','$nobkm','$toadally','$toadally1','$toadally','0','0',kas-potongan,'1');";
  ...
  <tr>
    ...
    <td class="tg-0lax">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rp: <?php echo number_format(($toadally),0,'.','.')?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
