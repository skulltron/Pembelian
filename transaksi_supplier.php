    ...
    <div class="panel-body">
        ...
        <div class="panel-body">
            <table class="table table-responsive" border="1" style="width: 100%">
                ...
                $query=mysqli_query($conn, "SELECT * FROM tbtransaksi INNER JOIN tbsupplier ON tbtransaksi.id_supplier=tbsupplier.id_supplier WHERE status_transaksi='Di Keuangan' OR status_transaksi='Sukses';");
