    ...
    <div class="panel-body">
        ...
        <div class="panel-body">
            <table class="table table-responsive" border="1" style="width: 100%">
                ...
                $no=1;
                if ($q=='') {
                    $query=mysqli_query($conn, "SELECT * FROM tbtransaksi INNER JOIN tbsupplier ON tbtransaksi.id_supplier=tbsupplier.id_supplier WHERE status_transaksi!='pending';");
                }else {
                    $query=mysqli_query($conn, "SELECT * FROM tbtransaksi INNER JOIN tbsupplier ON tbtransaksi.id_supplier=tbsupplier.id_supplier WHERE status_transaksi!='Di Pembelian' OR status_transaksi='Di Keuangan' AND no_transaksi LIKE '%$q%';");
                }
